Release An Extension Release Or A Linked Extension Release
##########################################################

Once you have filled in all required data into the form
of a new extension release or linked extension release and saved
the form, you have to decide if and with which state you
want to publish the extension (linked) release.
...
.. image:: images/extension_release_publish1.png
   :width: 297


If an extension release or linked extension release should not
...
The (linked) extension release will get the state
